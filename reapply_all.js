...
// 3. Grid append logic
const gridTarget = `            const freq = db.adFrequencyScroll || 10;
            let finalHTML = '';
...
const gridReplacement = `            const freq = db.adFrequencyScroll || 10;
            ...
            // ETAPA 3: Inyectar tarjeta inteligente en grid aleatoriamente (0, 1, o 2)
...
// 4. Carousel append logic
const carouselTarget = `                let rowCardsHTML = '';
...
const carouselReplacement = `                let rowCardsHTML = '';
                ...
                // ETAPA 3: Inyectar tarjeta inteligente en carrusel horizontal aleatoriamente (0, 1, o 2)
...
content = content.replace(carouselTarget, carouselReplacement);
