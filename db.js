const defaultCatalogData = {
    ...
    modelsByTypeAndMake: {
        ...
        'Sedán': {
            ...
            'Nissan': ['Versa', 'Sentra', 'March', 'Altima', 'Note', 'Maxima', 'Tiida', 'V-Drive'],
            'Volkswagen': ['Polo', 'Vento', 'Virtus', 'Jetta', 'Golf', 'Beetle', 'Passat', 'Derby', 'Pointer', 'Bora'],
            ...
            'Peugeot': ['208', '301', '308', '508'],
            'Renault': ['Kwid', 'Logan', 'Clio', 'Megane'],
            ...
            'Fiat': ['Mobi', 'Argo', '500', 'Uno', 'Palio', 'Siena'],
        ...
        'Camioneta': {
            ...
            'Toyota': ['Avanza', 'Corolla Cross', 'RAV4', 'Highlander', 'Sienna', '4Runner', 'Sequoia', 'Land Cruiser', 'Hiace', 'C-HR', 'Raize', 'Rush'],
            'Nissan': ['Kicks', 'X-Trail', 'Pathfinder', 'Armada', 'Juke', 'Murano', 'Urvan'],
            ...
            'Renault': ['Stepway', 'Duster', 'Captur', 'Koleos', 'Kangoo']
        },
        'Deportivo': {
            'Ford': ['Mustang'],
