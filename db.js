const defaultCatalogData = {
    ...
    modelsByMake: {
        ...
        'Polaris': ['RZR', 'RZR XP 1000', 'RZR Turbo R', 'Ranger', 'General', 'Sportsman', 'Scrambler'],
        ...
        'Saturn': ['Vue', 'Ion', 'Aura'],
        'Scania': ['Serie R', 'Serie S', 'Serie G'],
        'Scion': ['tC', 'xB', 'FR-S'],
        ...
        'Volkswagen': ['Polo', 'Vento', 'Virtus', 'Jetta', 'Golf', 'Nivus', 'T-Cross', 'Taos', 'Tiguan', 'Teramont', 'Atlas', 'Amarok', 'Saveiro', 'Transporter', 'Crafter'],
        'Volvo': ['S60', 'S90', 'V60', 'XC40', 'XC60', 'XC90', 'C40', 'VNL', 'VNR'],
