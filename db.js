const APP_VERSION = "3.17.39"; // Incrementa este valor cada vez que actualices el catálogo o estructura
...
const defaultCatalogData = {
    ...
    modelsByTypeAndMake: {
        ...
        'Sedán': {
            'Ford': ['Fusion', 'Focus', 'Fiesta', 'Figo', 'Mustang'],
            'Chevrolet': ['Aveo', 'Beat', 'Cavalier', 'Onix', 'Cruze', 'Spark', 'Malibu', 'Camaro', 'Corvette'],
            'Toyota': ['Yaris', 'Corolla', 'Camry', 'Prius', 'Supra', 'GR86'],
            'Nissan': ['Versa', 'Sentra', 'Altima', 'Maxima', 'Tiida', 'V-Drive', 'March', 'Note', '370Z', 'GT-R', 'Z'],
            'Volkswagen': ['Vento', 'Virtus', 'Jetta', 'Passat', 'Derby', 'Pointer', 'Bora', 'Polo', 'Golf', 'Beetle', 'Golf GTI'],
            'Honda': ['Civic', 'Accord', 'City', 'Fit', 'Civic Type R'],
            'Hyundai': ['Grand i10', 'Elantra', 'Accent', 'Sonata'],
            'Kia': ['Rio', 'Forte', 'K3', 'Optima', 'Soul'],
            'Mazda': ['Mazda 2', 'Mazda 3', 'Mazda 6', 'MX-5 Miata'],
            'Dodge': ['Attitude', 'Charger', 'Neon', 'Dart', 'Challenger', 'Viper'],
            'SEAT': ['Toledo', 'Ibiza', 'Leon'],
            'BMW': ['Serie 1', 'Serie 2', 'Serie 3', 'Serie 4', 'Serie 5', 'Serie 7', 'i4', 'Z4', 'M3', 'M4', 'M5'],
            'Mercedes-Benz': ['Clase A', 'Clase C', 'Clase E', 'Clase S', 'CLA', 'CLS', 'AMG GT', 'SL'],
            'Audi': ['A1', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'TT', 'R8'],
            'Peugeot': ['301', '508', '208', '308'],
            'Renault': ['Logan', 'Megane', 'Kwid', 'Clio', 'Sandero'],
            'MINI': ['Cooper', 'Cooper S'],
            'MG': ['MG GT', 'MG5', 'MG4 EV', 'MG3'],
            'Subaru': ['Impreza', 'WRX', 'Legacy', 'BRZ'],
            ...
            'Fiat': ['Argo', 'Palio', 'Siena', 'Mobi', '500', 'Uno'],
        ...
        'Cuatrimoto / ATV': {
            'Honda': ['TRX250X', 'TRX450R', 'FourTrax Rancher', 'FourTrax Foreman', 'FourTrax Rubicon', 'Pioneer 500', 'Pioneer 700', 'Pioneer 1000', 'Talon 1000R', 'Talon 1000X', 'Sportrax 400EX', 'TRX90X'],
            'Can-Am': ['Maverick X3', 'Maverick R', 'Defender', 'Commander', 'Outlander 450', 'Outlander 570', 'Outlander 850', 'Outlander 1000', 'Renegade 650', 'Renegade 1000', 'DS 250', 'Traxter'],
            'Polaris': ['RZR XP 1000', 'RZR Pro R', 'RZR Turbo R', 'RZR Trail', 'Ranger 1000', 'Ranger 570', 'General XP 1000', 'Sportsman 570', 'Sportsman 850', 'Sportsman 1000', 'Scrambler XP 1000', 'Outlaw 110', 'Phoenix 200'],
            'Yamaha': ['Raptor 700R', 'YFZ450R', 'Grizzly 700', 'Kodiak 450', 'Kodiak 700', 'YXZ1000R', 'Wolverine RMAX', 'Banshee 350', 'Blaster 200', 'Raptor 350', 'Raptor 90'],
            'Kawasaki': ['Brute Force 300', 'Brute Force 750', 'Teryx KRX 1000', 'Teryx4', 'Mule PRO-FXT', 'Mule SX', 'KFX 450R', 'KFX 90', 'KFX 50'],
            'CFMoto': ['CFORCE 450', 'CFORCE 520', 'CFORCE 600', 'CFORCE 850', 'CFORCE 1000', 'UFORCE 600', 'UFORCE 1000', 'ZFORCE 800', 'ZFORCE 950', 'ZFORCE 1000'],
            'Suzuki': ['KingQuad 400', 'KingQuad 500', 'KingQuad 750', 'QuadSport Z400', 'QuadRacer R450', 'Ozark 250', 'QuadSport Z90'],
            'Italika': ['ATV 150', 'ATV 180', 'ATV 200', 'ATV 250'],
            'Vento': ['Rhino 150', 'Rhino 200', 'Reptile 150', 'Reptile 200', 'Gladiator 200']
        },
        'Motocicleta': {
            'Honda': ['CBR600RR', 'CBR1000RR', 'CRF250L', 'XR150L', 'NAVI', 'Dio 110', 'CB190R', 'Shadow', 'Rebel 300', 'Rebel 500', 'Rebel 1100', 'Gold Wing', 'Africa Twin', 'XRE 300', 'CB650R', 'CRF450R', 'CBR300R', 'CBR500R', 'CB300R', 'Crux 110'],
            'Yamaha': ['YZF-R3', 'YZF-R6', 'YZF-R1', 'MT-03', 'MT-07', 'MT-09', 'FZ25', 'FZ-S', 'Crypton 110', 'Ray ZR', 'Tenere 700', 'YZ250F', 'YZ450F', 'NMAX', 'BWS 125', 'YBR125', 'XSR700', 'XSR900', 'Tracer 9'],
            'Suzuki': ['GSX-R600', 'GSX-R750', 'GSX-R1000', 'Hayabusa', 'Gixxer 150', 'Gixxer 250', 'V-Strom 650', 'V-Strom 1050', 'Boulevard', 'DR650', 'RM-Z250', 'Burgman', 'AX100', 'GN125', 'Katana', 'GSX-S750'],
            'Kawasaki': ['Ninja 400', 'Ninja 650', 'Ninja ZX-6R', 'Ninja ZX-10R', 'Ninja ZX-4RR', 'Z400', 'Z650', 'Z900', 'Versys 650', 'KX250', 'KX450', 'KLR650', 'KLX300', 'Vulcan S', 'Eliminator'],
            'BMW': ['R 1250 GS', 'R 1300 GS', 'S 1000 RR', 'G 310 R', 'G 310 GS', 'F 850 GS', 'F 900 R', 'F 900 XR', 'R 18', 'M 1000 RR', 'C 400 GT', 'R nineT'],
            'KTM': ['200 Duke', '250 Duke', '390 Duke', '790 Duke', '890 Duke', '1290 Super Duke R', '390 Adventure', '890 Adventure', '1290 Super Adventure', 'RC 200', 'RC 390', '250 EXC', '300 EXC', '450 SX-F'],
            'Harley-Davidson': ['Sportster S', 'Iron 883', 'Street Glide', 'Road Glide', 'Fat Boy', 'Heritage Classic', 'Pan America 1250', 'Softail Standard', 'Road King', 'Breakout', 'Nightster', 'Ultra Limited', 'Low Rider S', 'Forty-Eight'],
            'Italika': ['FT125', 'FT150', 'DM200', 'DM250', 'VX250', 'WS150', 'Vortex 300', 'Vort-X 200', 'AT110', 'D125', 'RT200', 'RT250', 'FT250TS', 'SPTFIRE', 'Modena 175', '125Z', '150Z', '250Z'],
            'Vento': ['Nitrox 250', 'Crossmax 200', 'Crossmax 250', 'Rocketman 250', 'Hyper 280', 'Screamer 250', 'Falkon 200', 'Tornado 250', 'Storm 250', 'Lithium 150', 'Ryder 150', 'Atom 150', 'Spectra 7', 'Lucky 7'],
            'Bajaj': ['Pulsar NS200', 'Pulsar N250', 'Pulsar NS160', 'Dominar 400', 'Dominar 250', 'Platina 110', 'Avenger 220', 'Boxer 150', 'Chetak', 'Pulsar 150', 'Discover 125', 'Pulsar RS200', 'Pulsar N160'],
            'Ducati': ['Panigale V4', 'Panigale V2', 'Monster', 'Multistrada V4', 'Scrambler', 'Streetfighter V4', 'Diavel 1260', 'Hypermotard 950', 'DesertX', 'SuperSport 950'],
            'Triumph': ['Bonneville T100', 'Bonneville T120', 'Street Triple 765', 'Speed Triple 1200', 'Tiger 900', 'Tiger 1200', 'Scrambler 900', 'Trident 660', 'Rocket 3', 'Speed 400', 'Scrambler 400 X'],
            'Royal Enfield': ['Classic 350', 'Meteor 350', 'Hunter 350', 'Himalayan 450', 'Interceptor 650', 'Continental GT 650', 'Super Meteor 650', 'Bullet 350', 'Shotgun 650'],
            'Indian Motorcycle': ['Scout', 'Scout Bobber', 'Chief', 'FTR 1200', 'Challenger', 'Roadmaster', 'Chieftain', 'Pursuit', 'Springfield'],
            'CFMoto': ['300NK', '450SR', '650NK', '700CL-X', '800NK', '800MT', '300SS', '450SS', '450MT', 'Papio'],
            'Aprilia': ['RS 660', 'Tuono V4', 'SR GT', 'RSV4', 'Tuareg 660', 'SXR 160', 'Tuono 660', 'RS 457'],
            'Can-Am': ['Spyder F3', 'Spyder RT', 'Ryker', 'Ryker Rally', 'Ryker Sport'],
            'Hero': ['Thruster', 'Hunk 160R', 'Hunk 190R', 'Xpulse 200', 'Xpulse 200 4V', 'Dash 125', 'Eco 150', 'Splendor', 'Karizma XMR'],
            'TVS': ['Apache RTR 160', 'Apache RTR 200 4V', 'Apache RR 310', 'NTorq 125', 'HLX 150', 'Raider 125', 'Ronin'],
            'Veloci': ['Xeverus 250', 'Razzer 200', 'Dynamik 150', 'Aggressor 250', 'Boxter 150', 'Hasback 200', 'Revenge 200', 'DarkSide 250'],
            'Kymco': ['Agility 125', 'Like 150', 'Downtown 350', 'AK 550', 'Super 8', 'X-Town 300']
        },
        'Barco': {
            'Sea-Doo': ['Spark', 'Spark Trixx', 'GTI 130', 'GTI 170', 'GTX 170', 'GTX 230', 'GTX 300', 'RXT-X 325', 'RXP-X 325', 'FishPro Scout', 'FishPro Sport', 'Wake Pro', 'Explorer Pro', 'Switch'],
            'Yamaha': ['WaveRunner VX', 'WaveRunner FX Cruiser', 'WaveRunner GP1800R', 'SuperJet', '255 FSH Sport', '222S', '275SD', 'AR190', 'SX190', '252SD'],
            'Kawasaki': ['Jet Ski Ultra 310LX', 'Jet Ski Ultra 160LX', 'Jet Ski STX 160', 'Jet Ski SX-R 1500 (Stand-up)', 'Ultra 310X'],
            'Honda': ['AquaTrax F-12X', 'AquaTrax R-12X', 'Lancha Fuera de Borda', 'Embarcación BF150', 'Embarcación BF250'],
