const defaultCatalogData = {
    makes: [
        ...
        'Cadillac', 'Changan', 'Chevrolet', 'Chirey', 'Chrysler', 'Cupra', 'Dodge', 'Ferrari', 
        'Fiat', 'Ford', 'Foton', 'Genesis', 'GMC', 'GWM', 'Honda', 'Hummer', 'Hyundai', 'Infiniti', 
        'Isuzu', 'JAC', 'JAECOO', 'Jaguar', 'Jeep', 'Jetour', 'Kenworth', 'Kia', 'Land Rover', 
        'Lexus', 'Lincoln', 'Lucid', 'Maserati', 'Mazda', 'McLaren', 'Mercedes-Benz', 'MG', 'MINI', 
        'Mitsubishi', 'Nissan', 'Omoda', 'Peugeot', 'Polestar', 'Pontiac', 'Porsche', 'Ram', 
        'Renault', 'Rivian', 'Saturn', 'Scion', 'Sea-Doo', 'SEAT', 'Subaru', 'Suzuki', 'Tesla', 
    ...
    modelsByMake: {
        ...
        'Honda': ['City', 'Civic', 'Accord', 'BR-V', 'HR-V', 'CR-V', 'Pilot', 'Odyssey', 'Ridgeline'],
        'Hummer': ['H2', 'H3', 'EV'],
