const defaultCatalogData = {
    makes: [
        ...
        'Chrysler', 'Cupra', 'Dodge', 'Ducati', 'Ferrari', 'Fiat', 'Ford', 'Foton', 'Genesis', 
        'GMC', 'GWM', 'Harley-Davidson', 'Hero', 'Honda', 'Hummer', 'Hyundai', 'Indian Motorcycle', 
        'Infiniti', 'Isuzu', 'Italika', 'JAC', 'JAECOO', 'Jaguar', 'Jeep', 'Jetour', 'Kawasaki', 
        'Kenworth', 'Kia', 'KTM', 'Kymco', 'Land Rover', 'Lexus', 'Lincoln', 'Lucid', 'Maserati', 
        'Mazda', 'McLaren', 'Mercedes-Benz', 'MG', 'MINI', 'Mitsubishi', 'Nissan', 'Omoda', 
        'Peugeot', 'Polaris', 'Polestar', 'Pontiac', 'Porsche', 'Ram', 'Renault', 'Rivian', 
        'Royal Enfield', 'Saturn', 'Scion', 'Sea-Doo', 'SEAT', 'Subaru', 'Suzuki', 'Tesla', 
        'Toyota', 'Triumph', 'TVS', 'Veloci', 'Vento', 'Volkswagen', 'Volvo', 'Yamaha'
    ],
    modelsByMake: {
        'Acura': ['ILX', 'TLX', 'RDX', 'MDX', 'Integra'],
        'Alfa Romeo': ['Giulia', 'Stelvio', 'Tonale'],
        'Aprilia': ['RS 660', 'Tuono V4', 'SR GT', 'RSV4'],
        'Aston Martin': ['Vantage', 'DB11', 'DBS', 'DBX'],
        'Audi': ['A1', 'A3', 'A4', 'A5', 'Q2', 'Q3', 'Q5', 'Q7', 'Q8', 'e-tron'],
        'BAIC': ['X35', 'BJ40', 'X55'],
        'Bajaj': ['Pulsar NS200', 'Pulsar N250', 'Dominar 400', 'Platina 110', 'Avenger 220'],
        'Bentley': ['Continental GT', 'Flying Spur', 'Bentayga'],
        'BMW': ['Serie 1', 'Serie 3', 'Serie 4', 'Serie 5', 'X1', 'X3', 'X4', 'X5', 'X6', 'i4', 'R 1250 GS', 'S 1000 RR', 'G 310 R', 'F 850 GS'],
        'Buick': ['Encore', 'Envision', 'Enclave'],
        'BYD': ['Dolphin', 'Seal', 'Yuan Plus', 'Han', 'Tang', 'Song Plus'],
        'Cadillac': ['XT4', 'XT5', 'Escalade', 'CT4', 'CT5'],
        'Can-Am': ['Maverick X3', 'Defender', 'Outlander', 'Renegade', 'Spyder', 'Ryker'],
        'CFMoto': ['NK 250', 'MT 800', 'CForce 520', 'UForce 1000', 'ZForce 1000'],
        'Changan': ['Alsvin', 'CS35 Plus', 'CS55 Plus', 'UNI-T', 'UNI-K'],
        'Chevrolet': ['Aveo', 'Onix', 'Cavalier', 'Captiva', 'Tracker', 'Groove', 'Silverado', 'Cheyenne', 'Tornado', 'Tahoe', 'Suburban', 'Camaro', 'Corvette', 'Equinox', 'Malibu'],
        'Chirey': ['Tiggo 2 Pro', 'Tiggo 4 Pro', 'Tiggo 7 Pro', 'Tiggo 8 Pro', 'Omoda 5'],
        'Chrysler': ['Pacifica', '300'],
        'Cupra': ['Ateca', 'Formentor', 'Leon'],
        'Dodge': ['Attitude', 'Journey', 'Charger', 'Challenger', 'Durango', 'Hornet'],
        'Ducati': ['Monster', 'Panigale V4', 'Scrambler', 'Multistrada', 'Diavel'],
        'Ferrari': ['Roma', 'Portofino', 'F8 Tributo', 'SF90 Stradale', '296 GTB'],
        'Fiat': ['Mobi', 'Argo', 'Fastback', 'Pulse', 'Ducato', '500'],
        'Ford': ['Figo', 'Fiesta', 'Focus', 'Mustang', 'Territory', 'Escape', 'Bronco', 'Explorer', 'Expedition', 'Ranger', 'Lobo', 'Maverick', 'Transit', 'F-150'],
        'Foton': ['Tunland', 'View'],
        'Genesis': ['G70', 'G80', 'G90', 'GV70', 'GV80'],
        'GMC': ['Terrain', 'Acadia', 'Sierra', 'Yukon', 'Canyon'],
        'GWM': ['Haval H6', 'Jolion', 'Poer', 'Ora 03'],
        'Harley-Davidson': ['Sportster', 'Iron 883', 'Street Glide', 'Road Glide', 'Fat Boy', 'Pan America'],
        'Hero': ['Eco 150', 'Xpulse 200', 'Hunk 160R'],
        'Honda': ['City', 'Civic', 'Accord', 'BR-V', 'HR-V', 'CR-V', 'Pilot', 'Odyssey', 'Ridgeline', 'Cargo 150', 'CB190R', 'CBR600RR', 'CRF250R', 'TRX420 ATV'],
        'Hummer': ['H2', 'H3', 'EV'],
        'Hyundai': ['Grand i10', 'Elantra', 'Sonata', 'Creta', 'Tucson', 'Santa Fe', 'Palisade', 'Kona', 'Ioniq 5'],
        'Indian Motorcycle': ['Scout', 'Chief', 'Challenger', 'FTR'],
        'Infiniti': ['Q50', 'QX50', 'QX55', 'QX60', 'QX80'],
        'Isuzu': ['D-Max', 'ELF'],
        'Italika': ['FT150', 'DM200', 'VX250', 'Vort-X 300', 'ATV180', 'WS150'],
        'JAC': ['J7', 'Sei 2', 'Sei 3 Pro', 'Sei 4 Pro', 'Sei 6 Pro', 'Sei 7 Pro', 'Frison T8'],
        'JAECOO': ['J7', 'J8'],
        ...
        'Kawasaki': ['Ninja 400', 'Ninja ZX-6R', 'Z650', 'KLR650', 'KX250', 'Mule', 'Teryx', 'Brute Force'],
        'Kenworth': ['T680', 'T880', 'W900'],
        'Kia': ['Picanto', 'Rio', 'K3', 'Forte', 'Optima', 'Soul', 'Seltos', 'Sportage', 'Sorento', 'Telluride', 'Niro', 'EV6'],
        'KTM': ['Duke 200', 'Duke 390', 'RC 390', '890 Adventure', '250 SX-F'],
        'Kymco': ['Agility 125', 'Like 150', 'AK 550', 'MXU 500'],
        'Land Rover': ['Range Rover', 'Range Rover Sport', 'Range Rover Velar', 'Range Rover Evoque', 'Discovery', 'Discovery Sport', 'Defender'],
        'Lexus': ['IS', 'ES', 'LS', 'UX', 'NX', 'RX', 'LX', 'GX'],
        'Lincoln': ['Corsair', 'Nautilus', 'Aviator', 'Navigator'],
        'Lucid': ['Air'],
        'Maserati': ['Ghibli', 'Quattroporte', 'Levante', 'Grecale'],
        'Mazda': ['Mazda2', 'Mazda3', 'Mazda6', 'CX-3', 'CX-30', 'CX-5', 'CX-50', 'CX-9', 'CX-90', 'MX-5'],
        'McLaren': ['Artura', '720S', 'GT'],
        'Mercedes-Benz': ['Clase A', 'Clase C', 'Clase E', 'Clase S', 'Clase G', 'GLA', 'GLB', 'GLC', 'GLE', 'GLS', 'EQS'],
        'MG': ['MG5', 'MG GT', 'ZS', 'HS', 'RX5', 'RX8', 'MG4'],
        'MINI': ['Cooper', 'Clubman', 'Countryman'],
        'Mitsubishi': ['Mirage', 'Lancer', 'Outlander', 'Montero', 'L200', 'Eclipse Cross'],
        'Nissan': ['March', 'V-Drive', 'Versa', 'Sentra', 'Altima', 'Maxima', 'Kicks', 'X-Trail', 'Pathfinder', 'Armada', 'Frontier', 'NP300', 'Urvan', 'Titan'],
        'Omoda': ['O5', 'C5'],
        'Peugeot': ['208', '301', '2008', '3008', '5008', 'Partner', 'Expert'],
        'Polaris': ['RZR', 'Ranger', 'General', 'Sportsman', 'Scrambler'],
        'Polestar': ['Polestar 2', 'Polestar 3'],
        'Pontiac': ['G6', 'Grand Am', 'Firebird', 'GTO'],
        ...
        'Subaru': ['Impreza', 'WRX', 'BRZ', 'Crosstrek', 'Forester', 'Outback', 'Ascent'],
        'Suzuki': ['Ignis', 'Swift', 'Baleno', 'Ertiga', 'Jimny', 'Vitara', 'S-Cross', 'Grand Vitara', 'AX100', 'GSX-R600', 'V-Strom 650', 'KingQuad 750'],
        'Tesla': ['Model 3', 'Model Y', 'Model S', 'Model X', 'Cybertruck'],
        'Toyota': ['Yaris', 'Corolla', 'Camry', 'Prius', 'Avanza', 'Corolla Cross', 'RAV4', 'Highlander', 'Sienna', 'Hilux', 'Tacoma', 'Tundra', '4Runner', 'Sequoia', 'Supra'],
        'Triumph': ['Street Triple', 'Bonneville', 'Tiger 900', 'Trident 660'],
        'TVS': ['Apache RTR 200', 'NTorq 125', 'Raider 125'],
        'Veloci': ['Razzer 200', 'Hasport 250', 'Xeverus 250', 'Stealth 200'],
        'Vento': ['Nitrox 250', 'Hyper 280', 'Crossmax 250', 'Screamer 250', 'Rocketman 250'],
        'Volkswagen': ['Polo', 'Vento', 'Virtus', 'Jetta', 'Golf', 'Nivus', 'T-Cross', 'Taos', 'Tiguan', 'Teramont', 'Atlas', 'Amarok', 'Saveiro', 'Transporter'],
        'Volvo': ['S60', 'S90', 'V60', 'XC40', 'XC60', 'XC90', 'C40'],
        'Yamaha': ['R6', 'MT-07', 'Fz-S', 'YZF-R1', 'Tenere 700', 'NMAX', 'R3', 'YFZ450R', 'Grizzly 700', 'Raptor 700', 'YXZ1000R']
    },
